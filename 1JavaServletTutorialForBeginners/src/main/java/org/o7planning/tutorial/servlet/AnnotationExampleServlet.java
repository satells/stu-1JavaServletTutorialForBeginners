...
@WebServlet(urlPatterns = { "/annotationExample", "/annExample" }, initParams = { @WebInitParam(name = "emailSupport1", value = "meu@email.com"),
	@WebInitParam(name = "emailSupport2", value = "support2@email.com") })
